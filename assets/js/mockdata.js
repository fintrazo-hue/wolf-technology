const MOCK_DATA = {
  ...
  accountsOnboarding: [
    { id: 'B001', billingId: 'BL001', customerName: 'Acme Corp', serviceName: 'Enterprise Plan', assignedAgent: 'E004', assignedAgentName: 'Neha Gupta', assignedTL: 'E002', assignedTLName: 'Priya Sharma', currentStep: 'Agreement Signed', completedSteps: ['Welcome to Wolf Technologies', 'Candidate Onboard', 'Get Documents', 'Agreement Sent', 'Agreement Signed'], lastUpdate: '2024-12-11T15:30:00', documents: { resume: 'uploaded', id_proof: 'uploaded', education_docs: 'uploaded' }, agreement: { sent_at: '2024-12-08T10:00:00', signed_at: '2024-12-11T14:00:00' }, status: 'completed', daysInProcess: 5 },
    { id: 'B002', billingId: 'BL002', customerName: 'TechStart Inc', serviceName: 'Pro Plan', assignedAgent: 'E005', assignedAgentName: 'Vikram Singh', assignedTL: 'E002', assignedTLName: 'Priya Sharma', currentStep: 'Agreement Sent', completedSteps: ['Welcome to Wolf Technologies', 'Candidate Onboard', 'Get Documents', 'Agreement Sent'], lastUpdate: '2024-12-11T10:15:00', documents: { resume: 'uploaded', id_proof: 'uploaded', education_docs: 'pending' }, agreement: { sent_at: '2024-12-10T09:00:00', signed_at: null }, status: 'pending', daysInProcess: 3 },
    { id: 'B003', billingId: 'BL003', customerName: 'Global Services Ltd', serviceName: 'Premium Plan', assignedAgent: 'E006', assignedAgentName: 'Anjali Mehta', assignedTL: 'E003', assignedTLName: 'Amit Patel', currentStep: 'Get Documents', completedSteps: ['Welcome to Wolf Technologies', 'Candidate Onboard', 'Get Documents'], lastUpdate: '2024-12-11T11:45:00', documents: { resume: 'uploaded', id_proof: 'pending', education_docs: 'pending' }, agreement: { sent_at: null, signed_at: null }, status: 'in_progress', daysInProcess: 4 },
    { id: 'B004', billingId: 'BL004', customerName: 'Innovation Labs', serviceName: 'Basic Plan', assignedAgent: 'E007', assignedAgentName: 'Rohit Verma', assignedTL: 'E003', assignedTLName: 'Amit Patel', currentStep: 'Candidate Onboard', completedSteps: ['Welcome to Wolf Technologies', 'Candidate Onboard'], lastUpdate: '2024-12-10T13:20:00', documents: { resume: 'pending', id_proof: 'pending', education_docs: 'pending' }, agreement: { sent_at: null, signed_at: null }, status: 'in_progress', daysInProcess: 2 },
    { id: 'B005', billingId: 'BL005', customerName: 'Enterprise Solutions', serviceName: 'Enterprise Plan', assignedAgent: 'E004', assignedAgentName: 'Neha Gupta', assignedTL: 'E002', assignedTLName: 'Priya Sharma', currentStep: 'Welcome to Wolf Technologies', completedSteps: ['Welcome to Wolf Technologies'], lastUpdate: '2024-12-09T08:30:00', documents: { resume: 'pending', id_proof: 'pending', education_docs: 'pending' }, agreement: { sent_at: null, signed_at: null }, status: 'pending', daysInProcess: 3 },
    { id: 'B006', billingId: 'BL006', customerName: 'Digital Ventures', serviceName: 'Pro Plan', assignedAgent: 'E005', assignedAgentName: 'Vikram Singh', assignedTL: 'E002', assignedTLName: 'Priya Sharma', currentStep: 'Agreement Sent', completedSteps: ['Welcome to Wolf Technologies', 'Candidate Onboard', 'Get Documents', 'Agreement Sent'], lastUpdate: '2024-12-08T16:00:00', documents: { resume: 'uploaded', id_proof: 'uploaded', education_docs: 'uploaded' }, agreement: { sent_at: '2024-12-06T11:00:00', signed_at: null }, status: 'pending', daysInProcess: 6 },
    { id: 'B007', billingId: 'BL007', customerName: 'NextGen Systems', serviceName: 'Premium Plan', assignedAgent: 'E006', assignedAgentName: 'Anjali Mehta', assignedTL: 'E003', assignedTLName: 'Amit Patel', currentStep: 'Agreement Signed', completedSteps: ['Welcome to Wolf Technologies', 'Candidate Onboard', 'Get Documents', 'Agreement Sent', 'Agreement Signed'], lastUpdate: '2024-12-11T09:45:00', documents: { resume: 'uploaded', id_proof: 'uploaded', education_docs: 'uploaded' }, agreement: { sent_at: '2024-12-07T14:30:00', signed_at: '2024-12-11T09:00:00' }, status: 'completed', daysInProcess: 5 },
